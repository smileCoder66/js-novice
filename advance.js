...
//2. 箭头函数 
  ...
  //如果返回对象,则外加()
  const arrowFn5 = (num1, num2) => ({ num1: num1, num2: num2 })
...
// 11.Object.assign(target, ...sources)
  ...
  let newOb = Object.assign(obs,{b:4,c:5})
  let newOb1 = {...obs,...{b:4,c:5}}
...
// 14.Array.prototype.includes
  ...
  [1, 2, NaN].includes(NaN) //返回boolean true
